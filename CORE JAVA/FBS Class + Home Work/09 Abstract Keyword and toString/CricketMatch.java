...
class TestMatch extends CricketMatch {
	...
	public String toString() {
		return super.toString() +"Total days : "+this.days +"\nOvers Per Day : "+this.oversPerDay + "\nLunch  break : "+this.hasLunchBreak;
	}
...
class OneDayMatch extends CricketMatch {
	...
	public String toString() {
	return super.toString() + "Total Overs : "+ this.overs + "\nPP Overs : " +this.PPOvers + "\nTiming : "+this.dayNight;
	}
...
class T20Match extends CricketMatch {
	...
	public String toString() {
	return super.toString() + "Total Overs : "+this.overs + "\nPP Overs : "+this.PPOvers + "\nTiming : "+this.timeOuts + "\nhas Cheerleaders : "+this.hasCheerLeaders;
	}
