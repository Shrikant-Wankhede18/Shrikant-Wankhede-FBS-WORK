...
class TestDefence{
	...
	public static void main(String[] args) {
		...
		Army a1= new Army("India",1234,23452,256241,26718,368716,"Mumbai",76865,77765,76,79876,786,7,876);
		a1.display();
		System.out.println("--------------------------------------------------");
		Navy n1= new Navy("India",1234,23452,256241,26718,368716,"Mumbai",76865,77765,76,79876,786,7);
		n1.display();
		System.out.println("--------------------------------------------------");
		Airforce af1= new Airforce("India",1234,23452,256241,26718,368716,"Mumbai",76865,77765,76,79876,786,7);
		af1.display();
